                    ...
                    <li class="nav-item ">
                      <a href="{{ route('cart') }}" class="nav-link d-inline-block mt-2">
                          ...
                          @if ($carts > 0)
                            ...
                            <span  class="badge card-badge badge-success rounded-circle border border-success"  
                            style="margin-left: -10px;" >{{ $carts }}</span>
                          @else
