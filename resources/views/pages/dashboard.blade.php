      ...
      >
        <div class="container-fluid">
          ...
          <div class="dashboard-content">
            ...
            <!-- isi tabel recent transaksi -->
            <div class="row mt-3">
              <div class="col-12 mt-2">
                <h5 class="mb-3">Recent Transactions//Transaksi Terkini yang dijual oleh Store</h5>

                  {{-- pengambilan data sudah direlasi kedalam query yg ada di dashboard controller --}}
                    ...
                    <a href="{{ route('dashboard-transactions-details', $transaction->id) }}" class="card card-list d-block">
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-1">
                              <img
                                src="{{ Storage::url($transaction->product->product_galleries->first()->photos) ?? '' }}"
                                class="w-75"
                              />
                            </div>
