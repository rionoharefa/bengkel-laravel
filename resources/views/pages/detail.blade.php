            ...
            <div class="col-lg-2">
              <div class="row">
                <div
                  ...
                  data-aos-delay="100"
                >
                  <!-- v-for berfungsi melooping data dari function vue.js -->
                  <a href="#" @click="changeActive(index)">
                    <img
                      ...
                      alt=""
                    />
                    <!-- :class= berfungsi untuk menginilisiasi poto yang aktif melalui index poto yg di klik tersebut -->
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="col-12 col-lg-8">
                <ul class="list-unstyled">
                  ...
                  <li class="media">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Retno Aprillia</h5>
                  ...
                  <li class="media">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Riono Harefa</h5>
